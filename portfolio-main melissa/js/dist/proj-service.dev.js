...
function createProject(id, name, title, desc, url, urlCode, labels) {
  var publishedAt = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : Date.now();
  return {
    id: id,
    name: name,
    title: title,
...
createProjects();
console.log(gProjects); // function createProjects() {
